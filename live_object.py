...
if not downloaded_model_path.exists():
    download.download_file(model_url, downloaded_model_path.name, downloaded_model_path.parent)
...
video_file = "http://192.168.0.26:8000/stream?topic=/trace/camera_0"
